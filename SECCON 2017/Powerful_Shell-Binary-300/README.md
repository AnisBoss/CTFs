...
<br>
**Second Step**<br>
the script just makes some xored transformation between $text content and $f content ( we don't really need to understant what it exactly does ) <br>
we can easily add at the end "echo $plain" and the output is : <br>
```ascii
