...
# Solution
it's a simple Pyjail , we can get the source code of the script using :
```python
open(__file__).read()
```
...
Then just a simple XOR gives us the flag
```python
from pwn import *
print xor("392a3d3c2b3a22125d58595733031c0c070a043a071a37081d300b1d1f0b09".decode("hex"),"pythonwillhelpyouopenthedoor")
```
